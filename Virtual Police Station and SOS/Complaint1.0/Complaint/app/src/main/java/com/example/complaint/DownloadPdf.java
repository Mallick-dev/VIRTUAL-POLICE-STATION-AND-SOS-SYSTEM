...
public class DownloadPdf extends AppCompatActivity {// creating a variable for our Firebase Database.
    ...
    private void initializePDFView() {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(DownloadPdf.this, "Fail to get PDF url.", Toast.LENGTH_SHORT).show();
            }
        });
    }
